...
const ID_TYPES = [
  ...
  { value: "driving_license", label: "Driving License", placeholder: "DL20241234567", format: "SSYYYYNNNNNNN" },
            ...
            <div className="mt-6 grid gap-6">
              <div>
                ...
                <div className="relative mt-2">
                  <input
                    ...
                    className={`w-full rounded-xl border px-4 py-3 text-sm font-medium text-gray-900 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${errors.driverName
              ...
              <div>
                ...
                <div className="relative mt-2">
                  ...
                  <select
                    id="driverIdType"
                    value={formData.driverIdType || "aadhar"}
                    onChange={(e) => handleInputChange("driverIdType", e.target.value)}
                    disabled={driverExists && !driverChanged}
                    className={`w-full pl-10 pr-4 py-3 rounded-xl border text-sm font-medium appearance-none ${driverExists && !driverChanged ? "bg-gray-100 cursor-not-allowed" : "bg-white cursor-pointer"
                      } border-gray-300`}
                  >
                    {ID_TYPES.map((idType) => (
              ...
              <div>
                ...
                <input
                  ...
                  name="driverAadhar"
                  type="text"
                  inputMode={(formData.driverIdType || "aadhar") === "aadhar" ? "numeric" : "text"}
                  value={formData.driverAadhar}
                  onChange={(e) =>
                    handleInputChange("driverAadhar", e.target.value)
                  }
                  placeholder={ID_TYPES.find(t => t.value === (formData.driverIdType || "aadhar"))?.placeholder || "Enter ID number"}
                  readOnly={driverExists && !driverChanged}
                  className={`mt-2 w-full rounded-xl border px-4 py-3 text-sm font-medium text-gray-900 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${driverExists && !driverChanged
                    ? "bg-gray-100"
                    : ""
                    } ${errors.driverAadhar
                      ? "border-red-400 bg-red-50"
                  ...
                  maxLength={(formData.driverIdType || "aadhar") === "driving_license" ? 16 : (formData.driverIdType || "aadhar") === "aadhar" ? 12 : 10}
                />
                {driverExists && !driverChanged && (
                  <p className="mt-1 text-xs text-gray-500">
                    ID number is locked for saved driver
                  </p>
                )}
                {errors.driverAadhar && (
                  <div className="mt-2 flex items-center gap-2 text-sm text-red-600">
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Format: {ID_TYPES.find(t => t.value === (formData.driverIdType || "aadhar"))?.format}
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-2 w-full rounded-xl border px-4 py-3 text-sm font-medium text-gray-900 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${errors.driverPhone
                    ? "border-red-400 bg-red-50"
                    : "border-gray-300 bg-white"
                    }`}
                />
                ...
                <div className="relative mt-2">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`w-full rounded-xl border ${errors.driverLanguage
                        ? "border-red-400 bg-red-50"
                        : "border-gray-300"
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <svg
                          className={`ml-auto h-4 w-4 text-gray-500 transform ${prefDropdownOpen
                            ? "rotate-180"
                            : "rotate-0"
                            }`}
                          viewBox="0 0 20 20"
                          ...
                          {languages
                            ...
                            .map((opt, idx) => (
                              <li
                                ...
                                className={`cursor-pointer px-4 py-2 text-sm ${formData.driverLanguage ===
                                  opt.value
          ...
          {!showHelperFields && (
            <div className="mt-6">
              <button
                ...
                disabled={!wantHelper || loading || savingHelper}
                style={{
                  opacity: wantHelper ? 1 : 0.5,
                  cursor: wantHelper ? 'pointer' : 'not-allowed',
                }}
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-green-600 px-4 py-3 text-sm font-semibold text-white transition-all duration-200 hover:bg-green-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:bg-green-300"
              >
                <User className="h-4 w-4" />
            ...
            <div className="mt-6 grid gap-6">
              <div>
                ...
                <div className="relative mt-2">
                  <input
                    ...
                    className={`w-full rounded-xl border px-4 py-3 text-sm font-medium text-gray-900 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${errors.helperName
                      ? "border-red-400 bg-red-50"
                      : "border-gray-300 bg-white"
                      }`}
                    autoComplete="name"
              ...
              <div>
                ...
                <div className="relative mt-2">
                  ...
                  <select
                    id="helperIdType"
                    value={formData.helperIdType || "aadhar"}
                    onChange={(e) => handleInputChange("helperIdType", e.target.value)}
                    disabled={helperExists && !helperChanged}
                    className={`w-full pl-10 pr-4 py-3 rounded-xl border text-sm font-medium appearance-none ${helperExists && !helperChanged ? "bg-gray-100 cursor-not-allowed" : "bg-white cursor-pointer"
                      } border-gray-300`}
                  >
                    {ID_TYPES.map((idType) => (
                      <option key={idType.value} value={idType.value}>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={ID_TYPES.find(t => t.value === (formData.helperIdType || "aadhar"))?.placeholder || "Enter ID number"}
                  readOnly={helperExists && !helperChanged}
                  className={`mt-2 w-full rounded-xl border px-4 py-3 text-sm font-medium text-gray-900 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${helperExists && !helperChanged
                    ? "bg-gray-100"
                    : ""
                    } ${errors.helperAadhar
                      ? "border-red-400 bg-red-50"
                  ...
                  maxLength={(formData.helperIdType || "aadhar") === "driving_license" ? 16 : (formData.helperIdType || "aadhar") === "aadhar" ? 12 : 10}
                />
                {helperExists && !helperChanged && (
                  <p className="mt-1 text-xs text-gray-500">
                    ID number is locked for saved helper
                  </p>
                )}
                {errors.helperAadhar && (
                  <div className="mt-2 flex items-center gap-2 text-sm text-red-600">
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Format: {ID_TYPES.find(t => t.value === (formData.helperIdType || "aadhar"))?.format}
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="+91XXXXXXXXXX"
                  className={`mt-2 w-full rounded-xl border px-4 py-3 text-sm font-medium text-gray-900 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${errors.helperPhone
                    ? "border-red-400 bg-red-50"
                    : "border-gray-300 bg-white"
                    }`}
                />
                ...
                <div className="relative mt-2">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`w-full rounded-xl border ${errors.helperLanguage
                        ? "border-red-400 bg-red-50"
                        : "border-gray-300"
                        } bg-white px-4 py-3 text-left text-sm font-medium text-gray-900 hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500`}
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <svg
                          className={`ml-auto h-4 w-4 text-gray-500 transform ${helperPrefDropdownOpen
                            ? "rotate-180"
                            : "rotate-0"
                            }`}
                          viewBox="0 0 20 20"
                          ...
                          {languages
                            ...
                            .map((opt, idx) => (
                              <li
                                ...
                                className={`cursor-pointer px-4 py-2 text-sm ${formData.helperLanguage ===
                                  opt.value
                                  ? "bg-blue-50 text-blue-700 font-semibold"
