...
import { Eye, EyeOff, AlertCircle, Loader, Truck, Mail, Lock, User, Phone, Building2 } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl bg-white p-8 shadow-xl">
          ...
          <p className="text-center text-sm text-gray-600 mb-6">
            Create an account to access the Advanced Vehicle Info System
          </p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-xl border text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${errors.company_name
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="John"
                    className={`w-full pl-10 pr-4 py-3 rounded-xl border text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${errors.firstname
                      ? "border-red-400 bg-red-50 placeholder:text-red-400 focus:ring-red-500"
                      : "border-gray-300 bg-white placeholder:text-gray-400 focus:ring-blue-500"
                      }`}
                    disabled={loading}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Doe"
                    className={`w-full pl-10 pr-4 py-3 rounded-xl border text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${errors.lastname
                      ? "border-red-400 bg-red-50 placeholder:text-red-400 focus:ring-red-500"
                      : "border-gray-300 bg-white placeholder:text-gray-400 focus:ring-blue-500"
                      }`}
                    disabled={loading}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-xl border text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${errors.phone
                    ? "border-red-400 bg-red-50 placeholder:text-red-400 focus:ring-red-500"
                    : "border-gray-300 bg-white placeholder:text-gray-400 focus:ring-blue-500"
                    }`}
                  disabled={loading}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-xl border text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${errors.email
                    ? "border-red-400 bg-red-50 placeholder:text-red-400 focus:ring-red-500"
                    : "border-gray-300 bg-white placeholder:text-gray-400 focus:ring-blue-500"
                    }`}
                  disabled={loading}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-3 rounded-xl border text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${errors.password
                    ? "border-red-400 bg-red-50 placeholder:text-red-400 focus:ring-red-500"
                    : "border-gray-300 bg-white placeholder:text-gray-400 focus:ring-blue-500"
                    }`}
                  disabled={loading}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-3 rounded-xl border text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${errors.verify_password
                    ? "border-red-400 bg-red-50 placeholder:text-red-400 focus:ring-red-500"
                    : "border-gray-300 bg-white placeholder:text-gray-400 focus:ring-blue-500"
                    }`}
                  disabled={loading}
